<template>
  <section id="services" class="bg-white">
    <div class="max-w-300 mx-auto px-4 md:px-10 py-10 md:py-16 text-center">
      <p
        class="text-xs font-bold tracking-widest uppercase text-brand-red mb-2"
      >
        Choose a Service
      </p>
      <h2
        class="text-2xl md:text-3xl font-extrabold text-brand-blue mb-8 md:mb-10"
      >
        The Lowest Pricing In Your Area
      </h2>
      ...
      >
        ...
        >
          ...
          <ul class="list-none p-0 mb-4 space-y-1">
            <li
